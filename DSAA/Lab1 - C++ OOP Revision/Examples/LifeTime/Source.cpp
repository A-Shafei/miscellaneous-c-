...
int main()
{
	...
	//Dynamic object
	//Checkpoint [3] ==> uncomment next line, and Rerun
	Point* P3= new Point(3,3);

	cout<<endl;

	//Checkpoint [2] ==> Uncomment (if statement), and Rerun
	
	if(true)
	{
		//Object defined in certain scope.
		Point P4(4,4);
		//Checkpoint [4] ==> uncomment next line, and Rerun
	...
	//Checkpoint [5] ==> uncomment next block, and Rerun,
	...
	//Checkpoint [6] ==> uncomment next line, and Rerun
	delete Ptr6;
